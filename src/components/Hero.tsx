    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-cream-light dark:bg-coffee-950 transition-colors duration-500 py-16 md:py-32">
            <div className="container mx-auto px-6 md:px-24 lg:px-32 relative z-10 flex flex-col items-center md:items-start justify-between">
                ...
                <div className="w-[90%] md:w-[38%] text-left">
                    <motion.div
                    ...
                    >
                        ...
                        <span className="text-accent font-bold tracking-[0.2em] md:tracking-[0.5em] uppercase text-[10px] md:text-sm">{t.hero.established}</span>
                    </motion.div>

                    <motion.h1
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="text-4xl md:text-8xl font-serif font-bold text-coffee-900 dark:text-cream-light leading-[1.1] mb-6 md:mb-12"
                    >
                    ...
                    >
                        <p className="text-base md:text-2xl text-coffee-700 dark:text-cream-dark max-w-xl leading-relaxed">
                            {t.hero.description}
                        </p>

                        <div className="flex gap-4 items-center mt-6 md:mt-12">
                            <a href="#menu" className="px-8 py-4 md:px-14 md:py-7 bg-coffee-900 dark:bg-accent text-white rounded-full font-bold text-lg md:text-2xl hover:scale-110 active:scale-95 transition-all shadow-xl">
                                {t.hero.cta}
                            </a>
                        </div>
                    </motion.div>
